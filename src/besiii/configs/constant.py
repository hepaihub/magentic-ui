...
PROMPTS_DIR = f'{REPO_ROOT}/besiii/configs/prompts'  # prompts目录
...
CONFIG_DIR = f'{REPO_ROOT}/besiii/configs'  # 配置目录

##
DEFAULT_MODEL = "openai/gpt-4o"  # for 创建assistant
...
# 
model_client_configs = f'{REPO_ROOT}/besiii/configs/drsai_config.yaml'  # prompts目录
