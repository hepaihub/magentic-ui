...
class DrSaiModelClientConfigs(BaseModel):
    ...
    planner: Optional[Union[ComponentModel, Dict[str, Any]]] = None
    coder: Optional[Union[ComponentModel, Dict[str, Any]]] = None
    tester: Optional[Union[ComponentModel, Dict[str, Any]]] = None
    host: Optional[Union[ComponentModel, Dict[str, Any]]] = None
    parser: Optional[Union[ComponentModel, Dict[str, Any]]] = None
...
class DrSaiMagenticUIConfig(BaseModel):
    """
    ...
    model_client_configs: DrSaiModelClientConfigs = Field(default_factory=DrSaiModelClientConfigs)
