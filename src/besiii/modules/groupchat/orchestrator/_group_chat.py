...
from besiii.magentic_utils.types import CheckpointEvent
from besiii.modules.learning.memory_provider import MemoryControllerProvider
trace_logger = logging.getLogger(TRACE_LOGGER_NAME)
event_logger = logging.getLogger(EVENT_LOGGER_NAME)


class DrSaiGroupChatConfig(BaseModel):
    participants: List[ComponentModel]
    model_client_parser: ComponentModel
    model_client_host: ComponentModel
    orchestrator_config: Dict[str, Any]
    termination_condition: ComponentModel | None = None


class DrSaiGroupChatState(BaseState):
    agent_states: Dict[str, Any]
    orchestrater_state: Any


class DrSaiGroupChat(BaseGroupChat, Component[DrSaiGroupChatConfig]):
    """
    args:
    ...
    component_config_schema = DrSaiGroupChatConfig
    component_provider_override = "besiii.modules.groupchat.orchestrator.GroupChat"

    def __init__(
        self,
        participants: List[ChatAgent],
        model_client_parser: ChatCompletionClient,
        model_client_host: ChatCompletionClient,
        ...
        *,
        ...
        self._model_client_parser = model_client_parser
        self._model_client_host = model_client_host
    ...
    def _create_group_chat_manager_factory(
        ...
        return lambda: Orchestrator(
            ...
            model_client_parser = self._model_client_parser,
            model_client_host = self._model_client_host,
    ...
    def _to_config(self) -> DrSaiGroupChatConfig:
        return DrSaiGroupChatConfig(
    ...
    @classmethod
    def _from_config(cls, config: DrSaiGroupChatConfig) -> "DrSaiGroupChat":
        return cls(
            participants=[
    ...
    async def close(self) -> None:
        ...
        await self._model_client_host.close()
        await self._model_client_parser.close()
